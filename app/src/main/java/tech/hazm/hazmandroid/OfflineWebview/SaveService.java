...
package tech.hazm.hazmandroid.OfflineWebview;
...
public class SaveService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		filePath = intent.getStringExtra(Constant.FILE_PATH);
		...
		public void run() {
			try {
				...
				if (sharedPreferences.getBoolean("generate_saved_page_thumbnails", true)) {
					...
					// file location of webview content
					EasyPreference.with(Common.myApp).addString(filePath, "file://" + newSavedPageDirectory.getPath() + File.separator + "index.html").save();
